...
public class InvDetailList {
	...
	public Long getIpdHeadDistNo() {
		return ipdHeadDistNo;
	}
	public void setIpdHeadDistNo(Long ipdHeadDistNo) {
		this.ipdHeadDistNo = ipdHeadDistNo;
	}
